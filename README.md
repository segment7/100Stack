...
| uTools | 按 `Alt+Space` 呼出，支持查日志、翻译、写Todo等功能，无需切屏。插件丰富，包括JSON格式化、正则调试、备忘录、截图OCR等。截图，翻译等等都可以 | Windows, macOS | 适用于需要快速调用多种工具的用户。 | [uTools](https://u.tools/) | Ubiquitous |
...
| TinyPNG | 该网站提供5M以内图片的免费基本无损压缩，速度非常快。 | Web | 适用于需要快速压缩小于5M图片的用户。 | [TinyPNG](https://tinypng.com/) | 未名市常驻 |
| Recompressor | 该网站提供超过5M图片的压缩，提供多个压缩大小版本，但速度较慢。 | Web | 适用于需要压缩大于5M图片的用户。 | [Recompressor](https://zh.recompressor.com/) | 未名市常驻 |
